  ...
  <div class="float-right">
    ...
    <div class="input-group input-group-sm">
        ...
        <span class="input-group-append">
          ...
          <a href="/admin/galeri" class="btn btn-info btn-flat tombol-hapus"><i class="fa fa-sync-alt"></i></a>
        </span>
      </div>
      </form>
  </div>
<table id="example1" class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/admin/galeri/{{$row->id}}"><b>{{$row->desc}}</a></b> </td>
      <td>
        <div class="btn-group">
            ...
            <div class="dropdown-menu" role="menu" x-placement="bottom-start">
              <a class="dropdown-item" href="/admin/galeri/{{$row->id}}/edit"><i class="fa fa-edit"></i> Edit</a>
                ...
                <form action="/admin/galeri/{{$row->id}}" method="post" id="form-delete" class="tombol-hapus">
                  @method('delete')
                  @csrf
